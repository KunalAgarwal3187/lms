...
export const AppContextProvider = (props) => {
    ...
    const value = {
        currency, allCourse, navigate, calculateRating, isEducator, setIsEducator, calculateChapterTime, calculateCourseDuration, calculateTotalLecture, enrolledCourses, backendUrl, setUserData, userData, getToken, fetchAllCourses,userEnrolledCourses
    }
    return (
