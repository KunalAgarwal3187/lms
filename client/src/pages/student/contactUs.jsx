...
const ContactUs = () => {
  ...
  const handleSubmit = (e) => {
    ...
    alert("Thanks for reaching out to Edemy!");
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-100 to-white p-6 flex items-center justify-center">
      <div className="bg-white shadow-2xl rounded-2xl max-w-6xl w-full grid md:grid-cols-2 gap-8 p-8">
        ...
        <div className="flex flex-col justify-center">
          <h2 className="text-4xl font-extrabold text-blue-700 mb-4">Contact Edemy</h2>
          ...
          <div className="text-gray-700 space-y-2">
            <p><strong>Email:</strong> support@edemy.com</p>
            <p><strong>Phone:</strong> +91 9001998599</p>
            <p><strong>Location:</strong> Bikaner, Rajasthan, India</p>
          </div>
        </div>
