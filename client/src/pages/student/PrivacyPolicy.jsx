  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-800 py-12 px-6 md:px-16">
      <div className="max-w-5xl mx-auto bg-white shadow-xl rounded-xl p-10">
        ...
        <p className="mb-6">
          At <span className="font-semibold text-blue-600">Edemy</span>, your privacy is our top priority. This Privacy Policy explains how we collect, use, and protect your personal information when you use our website and services.
        </p>
        ...
        <section className="mb-8">
          ...
          <p>
            Edemy is not intended for users under the age of 13. We do not knowingly collect data from children without parental consent.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            <span className="block font-semibold text-blue-700">privacy@edemy.com</span>
          </p>
        </section>
      </div>
    </div>
