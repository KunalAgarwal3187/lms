...
const CourseDetails = () => {
  ...
  const { currency, allCourse, calculateRating, calculateChapterTime, calculateCourseDuration, calculateTotalLecture,backendUrl,userData, getToken } = useContext(AppContext);
